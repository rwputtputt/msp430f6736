#[doc = "Register `SD24BCCTL0` reader"]
pub struct R(crate::R<SD24BCCTL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SD24BCCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SD24BCCTL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SD24BCCTL0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SD24BCCTL0` writer"]
pub struct W(crate::W<SD24BCCTL0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SD24BCCTL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SD24BCCTL0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SD24BCCTL0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SD24SC_W<'a> = crate::BitWriter<'a, u16, SD24BCCTL0_SPEC, bool, 0>;
...
pub type SD24SCS_W<'a> = crate::FieldWriterSafe<'a, u16, SD24BCCTL0_SPEC, u8, SD24SCS_A, 3, 1>;
impl<'a> SD24SCS_W<'a> {
...
pub type SD24DF_W<'a> = crate::FieldWriter<'a, u16, SD24BCCTL0_SPEC, u8, SD24DF_A, 2, 4>;
impl<'a> SD24DF_W<'a> {
...
pub type SD24ALGN_W<'a> = crate::BitWriter<'a, u16, SD24BCCTL0_SPEC, bool, 6>;
...
pub type SD24SNGL_W<'a> = crate::BitWriter<'a, u16, SD24BCCTL0_SPEC, bool, 8>;
...
pub type SD24CAL_W<'a> = crate::BitWriter<'a, u16, SD24BCCTL0_SPEC, bool, 9>;
...
pub type SD24DFS_W<'a> = crate::FieldWriterSafe<'a, u16, SD24BCCTL0_SPEC, u8, SD24DFS_A, 2, 10>;
impl<'a> SD24DFS_W<'a> {
...
pub type SD24DI_W<'a> = crate::BitWriter<'a, u16, SD24BCCTL0_SPEC, bool, 12>;
...
pub type SD24MC_W<'a> = crate::FieldWriterSafe<'a, u16, SD24BCCTL0_SPEC, u8, SD24MC_A, 2, 13>;
impl<'a> SD24MC_W<'a> {
...
#[doc = "SD24B Channel 0 Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sd24bcctl0](index.html) module"]
pub struct SD24BCCTL0_SPEC;
impl crate::RegisterSpec for SD24BCCTL0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [sd24bcctl0::R](R) reader structure"]
impl crate::Readable for SD24BCCTL0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sd24bcctl0::W](W) writer structure"]
impl crate::Writable for SD24BCCTL0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SD24BCCTL0 to value 0"]
impl crate::Resettable for SD24BCCTL0_SPEC {
    #[inline(always)]
