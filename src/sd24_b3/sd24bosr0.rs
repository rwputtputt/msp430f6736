#[doc = "Register `SD24BOSR0` reader"]
pub struct R(crate::R<SD24BOSR0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SD24BOSR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SD24BOSR0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SD24BOSR0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SD24BOSR0` writer"]
pub struct W(crate::W<SD24BOSR0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SD24BOSR0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SD24BOSR0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SD24BOSR0_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OSR0_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 0>;
...
pub type OSR1_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 1>;
...
pub type OSR2_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 2>;
...
pub type OSR3_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 3>;
...
pub type OSR4_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 4>;
...
pub type OSR5_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 5>;
...
pub type OSR6_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 6>;
...
pub type OSR7_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 7>;
...
pub type OSR8_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 8>;
...
pub type OSR9_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 9>;
...
pub type OSR10_W<'a> = crate::BitWriter<'a, u16, SD24BOSR0_SPEC, bool, 10>;
impl R {
...
#[doc = "SD24B Channel 0 OSR Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sd24bosr0](index.html) module"]
pub struct SD24BOSR0_SPEC;
impl crate::RegisterSpec for SD24BOSR0_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [sd24bosr0::R](R) reader structure"]
impl crate::Readable for SD24BOSR0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sd24bosr0::W](W) writer structure"]
impl crate::Writable for SD24BOSR0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SD24BOSR0 to value 0"]
impl crate::Resettable for SD24BOSR0_SPEC {
    #[inline(always)]
