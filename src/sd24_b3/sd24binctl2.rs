#[doc = "Register `SD24BINCTL2` reader"]
pub struct R(crate::R<SD24BINCTL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SD24BINCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SD24BINCTL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SD24BINCTL2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SD24BINCTL2` writer"]
pub struct W(crate::W<SD24BINCTL2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SD24BINCTL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SD24BINCTL2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SD24BINCTL2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SD24GAIN_W<'a> = crate::FieldWriterSafe<'a, u16, SD24BINCTL2_SPEC, u8, SD24GAIN_A, 3, 3>;
impl<'a> SD24GAIN_W<'a> {
    #[doc = "SD24B Input Pre-Amplifier Gain Select *0"]
    #[inline(always)]
...
pub type SD24INTDLY_W<'a> =
    crate::FieldWriterSafe<'a, u16, SD24BINCTL2_SPEC, u8, SD24INTDLY_A, 2, 6>;
...
#[doc = "SD24B Channel 2 Input Control Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [sd24binctl2](index.html) module"]
pub struct SD24BINCTL2_SPEC;
impl crate::RegisterSpec for SD24BINCTL2_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [sd24binctl2::R](R) reader structure"]
impl crate::Readable for SD24BINCTL2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [sd24binctl2::W](W) writer structure"]
impl crate::Writable for SD24BINCTL2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SD24BINCTL2 to value 0"]
impl crate::Resettable for SD24BINCTL2_SPEC {
    #[inline(always)]
