...
pub type SELM_W<'a> = crate::FieldWriterSafe<'a, u16, UCSCTL4_SPEC, u8, SELM_A, 3, 0>;
impl<'a> SELM_W<'a> {
...
pub type SELS_W<'a> = crate::FieldWriterSafe<'a, u16, UCSCTL4_SPEC, u8, SELS_A, 3, 4>;
impl<'a> SELS_W<'a> {
...
pub type SELA_W<'a> = crate::FieldWriterSafe<'a, u16, UCSCTL4_SPEC, u8, SELA_A, 3, 8>;
impl<'a> SELA_W<'a> {
