...
#[repr(u8)]
pub enum DMA2TSEL_A {
    #[doc = "0: DMA channel 2 transfer select 0"]
    DMA2TSEL_0 = 0,
    ...
    DMA2TSEL_29 = 29,
    #[doc = "30: DMA channel 2 transfer select 30"]
    DMA2TSEL_30 = 30,
    #[doc = "31: DMA channel 2 transfer select 31"]
    DMA2TSEL_31 = 31,
}
...
pub type DMA2TSEL_W<'a> = crate::FieldWriterSafe<'a, u16, DMACTL1_SPEC, u8, DMA2TSEL_A, 5, 0>;
impl<'a> DMA2TSEL_W<'a> {
    #[doc = "DMA channel 2 transfer select 0"]
    #[inline(always)]
    ...
    #[doc = "DMA channel 2 transfer select 30"]
    #[inline(always)]
    pub fn dma2tsel_30(self) -> &'a mut W {
        self.variant(DMA2TSEL_A::DMA2TSEL_30)
    }
    #[doc = "DMA channel 2 transfer select 31"]
    #[inline(always)]
