...
pub type UCBUSY_W<'a> = crate::BitWriter<'a, u8, UCA0STATW_SPI_SPEC, bool, 0>;
...
pub type UCOE_W<'a> = crate::BitWriter<'a, u8, UCA0STATW_SPI_SPEC, bool, 5>;
...
pub type UCFE_W<'a> = crate::BitWriter<'a, u8, UCA0STATW_SPI_SPEC, bool, 6>;
...
pub type UCLISTEN_W<'a> = crate::BitWriter<'a, u8, UCA0STATW_SPI_SPEC, bool, 7>;
impl R {
