...
pub struct RegisterBlock {
    ...
    #[doc = "0x0a - Port J Selection"]
    pub pjsel: crate::Reg<pjsel::PJSEL_SPEC>,
}
...
pub mod pjds;
#[doc = "PJSEL register accessor: an alias for `Reg<PJSEL_SPEC>`"]
pub type PJSEL = crate::Reg<pjsel::PJSEL_SPEC>;
