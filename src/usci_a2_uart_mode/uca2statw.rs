...
pub struct R(crate::R<UCA2STATW_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA2STATW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA2STATW_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA2STATW_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA2STATW` writer"]
pub struct W(crate::W<UCA2STATW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA2STATW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA2STATW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA2STATW_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCBUSY_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 0>;
...
pub type UCADDR_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 1>;
...
pub type UCRXERR_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 2>;
...
pub type UCBRK_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 3>;
...
pub type UCPE_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 4>;
...
pub type UCOE_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 5>;
...
pub type UCFE_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 6>;
...
pub type UCLISTEN_W<'a> = crate::BitWriter<'a, u8, UCA2STATW_SPEC, bool, 7>;
impl R {
...
#[doc = "USCI A2 Status Register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uca2statw](index.html) module"]
pub struct UCA2STATW_SPEC;
impl crate::RegisterSpec for UCA2STATW_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [uca2statw::R](R) reader structure"]
impl crate::Readable for UCA2STATW_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca2statw::W](W) writer structure"]
impl crate::Writable for UCA2STATW_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCA2STATW to value 0"]
impl crate::Resettable for UCA2STATW_SPEC {
    #[inline(always)]
