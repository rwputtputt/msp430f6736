...
pub struct R(crate::R<UCA2CTLW1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<UCA2CTLW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<UCA2CTLW1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<UCA2CTLW1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `UCA2CTLW1` writer"]
pub struct W(crate::W<UCA2CTLW1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<UCA2CTLW1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<UCA2CTLW1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<UCA2CTLW1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type UCGLIT_W<'a> = crate::FieldWriterSafe<'a, u16, UCA2CTLW1_SPEC, u8, UCGLIT_A, 2, 0>;
impl<'a> UCGLIT_W<'a> {
...
#[doc = "USCI A2 Control Word Register 1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [uca2ctlw1](index.html) module"]
pub struct UCA2CTLW1_SPEC;
impl crate::RegisterSpec for UCA2CTLW1_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [uca2ctlw1::R](R) reader structure"]
impl crate::Readable for UCA2CTLW1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [uca2ctlw1::W](W) writer structure"]
impl crate::Writable for UCA2CTLW1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets UCA2CTLW1 to value 0"]
impl crate::Resettable for UCA2CTLW1_SPEC {
    #[inline(always)]
