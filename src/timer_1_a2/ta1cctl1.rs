...
pub type CCIFG_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 0>;
...
pub type COV_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 1>;
...
pub type OUT_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 2>;
...
pub type CCI_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 3>;
...
pub type CCIE_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 4>;
#[doc = "Output mode 2\n\nValue on reset: 0"]
...
pub type OUTMOD_W<'a> = crate::FieldWriterSafe<'a, u16, TA1CCTL1_SPEC, u8, OUTMOD_A, 3, 5>;
impl<'a> OUTMOD_W<'a> {
...
pub type CAP_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 8>;
...
pub type SCCI_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 10>;
#[doc = "Field `SCS` reader - Capture sychronize"]
pub type SCS_R = crate::BitReader<bool>;
#[doc = "Field `SCS` writer - Capture sychronize"]
pub type SCS_W<'a> = crate::BitWriter<'a, u16, TA1CCTL1_SPEC, bool, 11>;
...
pub type CCIS_W<'a> = crate::FieldWriterSafe<'a, u16, TA1CCTL1_SPEC, u8, CCIS_A, 2, 12>;
impl<'a> CCIS_W<'a> {
...
pub type CM_W<'a> = crate::FieldWriterSafe<'a, u16, TA1CCTL1_SPEC, u8, CM_A, 2, 14>;
impl<'a> CM_W<'a> {
