#[doc = "Register `P1MAP4` reader"]
pub struct R(crate::R<P1MAP4_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<P1MAP4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<P1MAP4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<P1MAP4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `P1MAP4` writer"]
pub struct W(crate::W<P1MAP4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<P1MAP4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<P1MAP4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<P1MAP4_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "Port P1.4 mapping register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [p1map4](index.html) module"]
pub struct P1MAP4_SPEC;
impl crate::RegisterSpec for P1MAP4_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [p1map4::R](R) reader structure"]
impl crate::Readable for P1MAP4_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [p1map4::W](W) writer structure"]
impl crate::Writable for P1MAP4_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets P1MAP4 to value 0"]
impl crate::Resettable for P1MAP4_SPEC {
    #[inline(always)]
