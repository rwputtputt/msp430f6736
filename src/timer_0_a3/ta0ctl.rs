...
pub type TAIFG_W<'a> = crate::BitWriter<'a, u16, TA0CTL_SPEC, bool, 0>;
...
pub type TAIE_W<'a> = crate::BitWriter<'a, u16, TA0CTL_SPEC, bool, 1>;
...
pub type TACLR_W<'a> = crate::BitWriter<'a, u16, TA0CTL_SPEC, bool, 2>;
...
pub type MC_W<'a> = crate::FieldWriterSafe<'a, u16, TA0CTL_SPEC, u8, MC_A, 2, 4>;
impl<'a> MC_W<'a> {
...
pub type ID_W<'a> = crate::FieldWriterSafe<'a, u16, TA0CTL_SPEC, u8, ID_A, 2, 6>;
impl<'a> ID_W<'a> {
...
pub type TASSEL_W<'a> = crate::FieldWriterSafe<'a, u16, TA0CTL_SPEC, u8, TASSEL_A, 2, 8>;
impl<'a> TASSEL_W<'a> {
