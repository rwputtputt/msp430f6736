#[doc = "Register `AUX2CHCTL` reader"]
pub struct R(crate::R<AUX2CHCTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<AUX2CHCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<AUX2CHCTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<AUX2CHCTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `AUX2CHCTL` writer"]
pub struct W(crate::W<AUX2CHCTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<AUX2CHCTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<AUX2CHCTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<AUX2CHCTL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AUXCHEN_W<'a> = crate::BitWriter<'a, u16, AUX2CHCTL_SPEC, bool, 0>;
...
pub type AUXCHC_W<'a> = crate::FieldWriterSafe<'a, u16, AUX2CHCTL_SPEC, u8, AUXCHC_A, 2, 1>;
impl<'a> AUXCHC_W<'a> {
...
pub type AUXCHV_W<'a> = crate::FieldWriterSafe<'a, u16, AUX2CHCTL_SPEC, u8, AUXCHV_A, 2, 4>;
impl<'a> AUXCHV_W<'a> {
...
#[doc = "AUX2 Charger Control register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [aux2chctl](index.html) module"]
pub struct AUX2CHCTL_SPEC;
impl crate::RegisterSpec for AUX2CHCTL_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [aux2chctl::R](R) reader structure"]
impl crate::Readable for AUX2CHCTL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [aux2chctl::W](W) writer structure"]
impl crate::Writable for AUX2CHCTL_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets AUX2CHCTL to value 0"]
impl crate::Resettable for AUX2CHCTL_SPEC {
    #[inline(always)]
